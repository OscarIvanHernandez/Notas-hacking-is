...
┌─[oscar@oscar-parrot]─[~/reversing/2019/vault-door-5]
└──╼ $ls
VaultDoor5.java
┌─[oscar@oscar-parrot]─[~/reversing/2019/vault-door-5]
└──╼ $nano VaultDoor5.java 
┌─[oscar@oscar-parrot]─[~/reversing/2019/vault-door-5]
└──╼ $

  GNU nano 5.4                                                                           VaultDoor5.java                                                                                    
...
Usando CyberChef se decodifica de base64 y de ahi, se decodifica en URL 
y se obtiene 
