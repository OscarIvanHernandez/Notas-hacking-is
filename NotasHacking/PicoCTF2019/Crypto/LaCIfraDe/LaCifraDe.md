...
┌─[✗]─[oscar@oscar-parrot]─[~/crypto/2019/LaCifraDe]
...
## Notas adicionales
El mensaje estaba cifrado en Vigenere, se utilizo la pagina web https://www.guballa.de/vigenere-solver para encontrar la key por fuerza bruta"
